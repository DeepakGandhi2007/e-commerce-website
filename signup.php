          ...
          <div class="tab-pane fade active in" id="signup">
            ...
            <form id="signup">
              <div class="row">
                <div class="col-xs-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="f_name" class="form-control" id="first_name" required data-validation-required-message="Please enter your name." autocomplete="off">
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="l_name " class="form-control" id="last_name" required data-validation-required-message="Please enter your name." autocomplete="off">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="tel" name="mob" class="form-control" id="phone" required data-validation-required-message="Please enter your phone number." autocomplete="off">
                <p class="help-block text-danger"></p>
              </div>
              <div class="form-group">
              ...
              <br>
              <div style="margin-top:5px" class="mrgn-30-top">
